...
impl Default for OrbitalCamera {
    fn default() -> Self {
        ...
        c.SetFromEyeTarget([18.0, 14.0, 18.0], [0.0, 3.0, 0.0]);
        c
    }
}
...
impl OrbitalCamera {
    ...
    pub fn orbit(&mut self, dx: f32, dy: f32) {
        ...
        self.elevation = (self.elevation - dy * 0.007).clamp(
    ...
    pub fn WasdMove(&mut self, forward: f32, right: f32, up: f32) {
    ...
    pub fn SetFromEyeTarget(&mut self, eye: [f32; 3], target: [f32; 3]) {
